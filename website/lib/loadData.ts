...
export const CATEGORIES: CategoryConfig[] = [
  {
    slug: "llm-apis",
    label: "Free LLM APIs",
    title: "Free LLM APIs in 2026 — {count} providers with real limits and no-card flags",
    metaDescription:
  ...
  },
  {
    slug: "mcp-servers",
    label: "MCP Servers",
    title: "MCP servers list 2026 — {count} servers with copy-paste install commands",
    metaDescription:
